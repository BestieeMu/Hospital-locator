    ...
    <>
      <div className=" w-full flex justify-center items-center hero py-20">
        <div className="w-11/12 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="lg:w-5/12 md:w-6/12 w-full mt-10 md:mt-0">
            {/* hero title */}
            ...
            <p className="lg:text-lg  text-white text-sm mt-9">
              In an emergency, every second counts. Use our website to quickly
              find the nearest hospitals. Simply enter your location and we'll
              provide you with a list of nearby hospitals.
            </p>
            ...
            <div className="mt-8">
              <div className="flex flex-col w-full items-center lg:flex-row gap-4 mt-9">
                <Link to="locations" className="w-full">
                  <button
                    className="px-3 py-2 rounded border border-black w-full  font-medium "
          ...
          <div className="lg:w-6/12 md:w-5/12 w-11/12 mt-14">
            <img
              src={HeroImg}
              alt="person-with-phone-map"
              className="w-75 h-75 md:w-96 lg:ml-20 lg:w-9/12"
            />
          </div>
        </div>
      </div>
